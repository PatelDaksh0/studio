...
/**
 * @fileOverview Summarizes a news article given a URL.
 *
 * - summarizeArticle - A function that accepts a URL and returns a summary of the article.
...
const SummarizeArticleOutputSchema = z.object({
  ...
  country: z.string().optional().describe('The country the article is from.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the news article at the following URL in a concise manner:\n\nURL: {{{url}}}`,
});
